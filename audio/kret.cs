...
{
    public partial class kret : Form
    {
        private Timer timer;
        ...
        private void Timer_Tick(object sender, EventArgs e)
        {
            ...
            if (remainingSeconds <= 0)
            {
                ...
                //move to next form
                this.Hide();
                audio_info f7 = new audio_info(earnedcolorpoints,earnedPoints);
                f7.ShowDialog();
                this.Close();
            }
        ...
        private void kret_Load(object sender, EventArgs e)
        {
